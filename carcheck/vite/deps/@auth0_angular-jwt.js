...
var JwtHelperService = (
  /** @class */
  function() {
    function JwtHelperService2(config) {
      if (config === void 0) {
        config = null;
      }
    ...
    JwtHelperService2.prototype.urlBase64Decode = function(str) {
    ...
    JwtHelperService2.prototype.b64decode = // credits for decoder goes to https://github.com/atk
    function(str) {
    ...
    JwtHelperService2.prototype.b64DecodeUnicode = function(str) {
      return decodeURIComponent(Array.prototype.map.call(this.b64decode(str), function(c) {
        return "%" + ("00" + c.charCodeAt(0).toString(16)).slice(-2);
      }).join(""));
    };
    JwtHelperService2.prototype.decodeToken = function(token) {
      if (token === void 0) {
    ...
    JwtHelperService2.prototype.getTokenExpirationDate = function(token) {
      if (token === void 0) {
        token = this.tokenGetter();
      }
      var decoded;
    ...
    JwtHelperService2.prototype.isTokenExpired = function(token, offsetSeconds) {
      if (token === void 0) {
        token = this.tokenGetter();
      }
      if (token == null || token === "") {
    ...
    JwtHelperService2.decorators = [
      { type: Injectable }
    ];
    JwtHelperService2.ctorParameters = function() {
      return [
        { type: void 0, decorators: [{ type: Inject, args: [JWT_OPTIONS] }] }
      ];
    };
    return JwtHelperService2;
  }()
);
...
var JwtInterceptor = (
  /** @class */
  function() {
    function JwtInterceptor2(config, jwtHelper) {
    ...
    JwtInterceptor2.prototype.isWhitelistedDomain = function(request) {
      var requestUrl = (0, import_url.parse)(request.url, false, true);
    ...
    JwtInterceptor2.prototype.isBlacklistedRoute = function(request) {
      var url = request.url;
    ...
    JwtInterceptor2.prototype.handleInterception = function(token, request, next) {
    ...
    JwtInterceptor2.prototype.intercept = function(request, next) {
      var _this = this;
    ...
    JwtInterceptor2.decorators = [
      { type: Injectable }
    ];
    JwtInterceptor2.ctorParameters = function() {
      return [
        { type: void 0, decorators: [{ type: Inject, args: [JWT_OPTIONS] }] },
        { type: JwtHelperService }
      ];
    };
    return JwtInterceptor2;
  }()
);
...
var JwtModule = (
  /** @class */
  function() {
    function JwtModule2(parentModule) {
      if (parentModule) {
        throw new Error("JwtModule is already loaded. It should only be imported in your application's main module.");
      }
    }
    JwtModule2.forRoot = function(options) {
      return {
        ngModule: JwtModule2,
        providers: [
          {
    ...
    JwtModule2.decorators = [
      { type: NgModule }
    ];
    JwtModule2.ctorParameters = function() {
      return [
        { type: JwtModule2, decorators: [{ type: Optional }, { type: SkipSelf }] }
      ];
    };
    return JwtModule2;
  }()
