...
export class CreditoComponent implements OnInit {
  ...
  parcelas: any[] = [];
  cpfControl: FormControl = new FormControl('', { validators: UtilValidators.cpf });
  formMask = {
  ...
  constructor(private loginService: LoginService, public pagSeguro: PagSeguroService, private fb: FormBuilder, pessoaService: PessoaService) { }
