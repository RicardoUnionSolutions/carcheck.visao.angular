describe('Processo de compra único', () => {
  ...
  function visitarProcessoCompra() {
    cy.intercept('GET', '**/consultar/pegarConsultaCliente*', {
      fixture: 'consultas.json'
    }).as('consultas');
  ...
  it('exibe mensagem de erro quando os dados do veículo não são preenchidos', () => {
    visitarProcessoCompra();
    ...
    cy.contains('button', 'Continuar').click();
    cy.contains('Obrigatório preenchimento de Placa válida ou Chassi!').should('be.visible');
  });
});
