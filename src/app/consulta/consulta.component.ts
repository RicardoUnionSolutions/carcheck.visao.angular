...
export class ConsultaComponent implements OnInit {
  ...
  getUrlPdf() {
    return this.variableGlobal.getUrl(
      "consultar/relatorioConsultaPdf/" + this.tokenConsulta
    );
  }
  ...
  carregarInformacoes() {
    this.modal.openLoading({
      title: "Carregando Consulta",
      text: "Aguarde, em alguns segundos sua consulta será carregada.",
    });
    let request: any = this.dadosConsultaService.getConsultaVeiculo(
      this.tokenConsulta
    );
    const promise: Promise<any> =
      request && typeof request.toPromise === "function"
        ? request.toPromise()
    ...
    promise
      .then((data) => {
        ...
        this.removeAbas =
          this.dadosConsulta.composta.nome.toLowerCase() != "completa";

        this.marcaVeiculo =
          this.dadosConsulta.veiculo.marca != null
            ? this.dadosConsulta.veiculo.marca
                .toLowerCase()
                .replace(/ /g, "")
                .replace(/ /g, "")
            : "semmarca";
  ...
  downloadPdf() {
    this.modal.openLoading({
      ...
      text: "Aguarde, em alguns segundos o download do PDF será concluido.",
    });
    this.dadosConsultaService
      .downloadPdf(this.dadosConsulta.tokenConsulta)
      .subscribe(
        (data) => {
        ...
        (error) => {
          ...
          this.modal.openModalMsg({
            ...
            text: "Ocorreu um erro ao efetuar o download do PDF, tente novamente mais tarde, caso o problema persista, entre em contato com o nosso suporte.",
            cancel: { show: false },
          });
        }
      );
...
*/
  ...
  verificaPlaca() {
    if (
      this.dadosConsulta.veiculo != null &&
      this.dadosConsulta.veiculo.placa
    ) {
      return this.dadosConsulta.veiculo.placa;
    } else if (
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.placa
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.placa;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.placa
    ) {
      return this.dadosConsulta.binfederal.dadosveiculo.placa;
    } else if (
      this.dadosConsulta.binrf != null &&
      this.dadosConsulta.binrf.dadosveiculo != null &&
      this.dadosConsulta.binrf.dadosveiculo.length > 0 &&
      this.dadosConsulta.binrf.dadosveiculo[
        this.dadosConsulta.binrf.dadosveiculo.length - 1
      ].placa
    ) {
      return this.dadosConsulta.binrf.dadosveiculo[
        this.dadosConsulta.binrf.dadosveiculo.length - 1
      ].placa;
    } else if (
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.placa
    ) {
  ...
  verificaLogo() {
    const dados = this.dadosConsulta;

    // prefer data from "veiculo"
    if (dados.veiculo && dados.veiculo.marca) {
      let marcaVeiculo = dados.veiculo.marca
        ? dados.veiculo.marca.toLowerCase().replace(/ /g, "").replace(/ /g, "")
        : "semmarca";
      if (dados.veiculo.tipo === "Motocicleta" && marcaVeiculo !== "semmarca") {
        marcaVeiculo += "-moto";
      }
      return marcaVeiculo;
    }

    // fallback to SNVA data
    if (
      dados.snva &&
      dados.snva.dadosveiculo &&
      dados.snva.dadosveiculo.marca
    ) {
      let marcaVeiculo =
        dados.snva.dadosveiculo.marca.indexOf("I/") === -1
          ? dados.snva.dadosveiculo.marca
              .toLowerCase()
              .replace(/ /g, "")
              .replace(/ /g, "")
          : "semmarca";
      if (
        dados.snva.dadosveiculo.tipo === "Motocicleta" &&
        marcaVeiculo !== "semmarca"
      ) {
        marcaVeiculo += "-moto";
      }
    ...
    // finally check BINRF list
    if (
      dados.binrf &&
      dados.binrf.dadosveiculo &&
      dados.binrf.dadosveiculo.length > 0
    ) {
      const ultimo =
        dados.binrf.dadosveiculo[dados.binrf.dadosveiculo.length - 1];
      let marcaVeiculo =
        ultimo.marca && ultimo.marca.indexOf("I/") === -1
          ? ultimo.marca.toLowerCase().replace(/ /g, "").replace(/ /g, "")
          : "semmarca";
      if (ultimo.tipo === "Motocicleta" && marcaVeiculo !== "semmarca") {
        marcaVeiculo += "-moto";
      }
      return marcaVeiculo;
    }
  ...
  verificaMarca() {
    if (
      ...
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.marca
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.marca;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.marca
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.marca
    ) {
  ...
  verificaModelo() {
    if (
      this.dadosConsulta.veiculo != null &&
      this.dadosConsulta.veiculo.modeloBin
    ) {
      return this.dadosConsulta.veiculo.modeloBin;
    } else if (
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.modelo
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.modelo;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.modelo
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.modelo
    ) {
  ...
  verificaAnoModelo() {
    if (
      this.dadosConsulta.veiculo != null &&
      this.dadosConsulta.veiculo.anoModelo
    ) {
      return this.dadosConsulta.veiculo.anoModelo;
    } else if (
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.anoModelo
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.anoModelo;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.anoModelo
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.anoModelo
    ) {
  ...
  verificaAnoFabricacao() {
    if (
      this.dadosConsulta.veiculo != null &&
      this.dadosConsulta.veiculo.anoFabricacao
    ) {
      return this.dadosConsulta.veiculo.anoFabricacao;
    } else if (
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.anoFabricacao
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.anoFabricacao;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.anoFabricacao
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.anoFabricacao
    ) {
  ...
  verificaCilindradas() {
    if (
      this.dadosConsulta.veiculo != null &&
      this.dadosConsulta.veiculo.cilindrada
    ) {
      return this.dadosConsulta.veiculo.cilindrada;
    } else if (
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.cilindrada
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.cilindrada;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.cilindrada
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.cilindrada
    ) {
  ...
  verificaEstado() {
    if (this.dadosConsulta.veiculo != null && this.dadosConsulta.veiculo.uf) {
      ...
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.uf
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.uf;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.uf
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.uf
    ) {
  ...
  verificaMunicipio() {
    if (
      this.dadosConsulta.veiculo != null &&
      this.dadosConsulta.veiculo.municipio
    ) {
      return this.dadosConsulta.veiculo.municipio;
    } else if (
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.municipio
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.municipio;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.municipio
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.municipio
    ) {
  ...
  verificaIdConsulta() {
    if (this.dadosConsulta.veiculo != null && this.dadosConsulta.id) {
      ...
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.id
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.id;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.id
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.id
    ) {
  ...
  verificaCor() {
    if (this.dadosConsulta.veiculo != null && this.dadosConsulta.veiculo.cor) {
      ...
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.cor
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.cor;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.cor
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.cor
    ) {
  ...
  verificaChassi() {
    if (
      this.dadosConsulta.veiculo != null &&
      this.dadosConsulta.veiculo.chassi
    ) {
      return this.dadosConsulta.veiculo.chassi;
    } else if (
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.chassi
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.chassi;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.chassi
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.chassi
    ) {
  ...
  verificaCombustivel() {
    if (
      this.dadosConsulta.veiculo != null &&
      this.dadosConsulta.veiculo.combustivel
    ) {
      return this.dadosConsulta.veiculo.combustivel;
    } else if (
      this.dadosConsulta.binestadual != null &&
      this.dadosConsulta.binestadual.dadosveiculo != null &&
      this.dadosConsulta.binestadual.dadosveiculo.combustivel
    ) {
      return this.dadosConsulta.binestadual.dadosveiculo.combustivel;
    } else if (
      this.dadosConsulta.binfederal != null &&
      this.dadosConsulta.binfederal.dadosveiculo != null &&
      this.dadosConsulta.binfederal.dadosveiculo.combustivel
    ) {
      ...
      this.dadosConsulta.snva != null &&
      this.dadosConsulta.snva.dadosveiculo != null &&
      this.dadosConsulta.snva.dadosveiculo.combustivel
    ) {
  ...
  verificaGravame() {
    if (
      this.dadosConsulta.binestadual.dadosGravame != null &&
      Object.values(this.dadosConsulta.binestadual.dadosGravame).length != 0 &&
      this.dadosConsulta.binestadual.dadosGravame?.tipoRestricao.toUpperCase() !=
        "NADA CONSTA"
    ) {
      return true;
    }
